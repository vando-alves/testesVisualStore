    ...
    this.executar = function(consulta, filtro, groupby, qtdLinhas) {
        ...
        if (filtro){
        	if (groupby){
        		...
        		if(qtdLinhas){
        			parent.showframe('br/com/visualmix/generico/jsppesquisar/Event.jsp?evento=executar::' + consulta + VSEP1 + filtro + VSEP1 + VSEP1 + qtdLinhas + '&objeto=' + this.name + '&titulo=' + this.titulo, 580, 435);
        		}else{

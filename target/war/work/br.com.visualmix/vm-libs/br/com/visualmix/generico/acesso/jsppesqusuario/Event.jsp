...
<%
    String classe 	= "br.com.visualmix.generico.acesso.jsppesqusuario.Tela";	
	String bean 	= request.getParameter("beanid");
	String permissoes = request.getParameter("permissoes");
	String diretorio = "jsppesqusuario";
	Folder objtela;
	Conexao conexao;
...
//    	System.out.println(e);
	...
	if(objtela.adicionarTela) {
		telas.adicionar(bean, request.getContextPath() + path + diretorio + "/Event.jsp",objtela.getTitle()); 	
	}
